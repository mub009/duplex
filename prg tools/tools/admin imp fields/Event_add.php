...
<tr>
    ...
    <td width="156" height="56"  align="right"><div class="form-group"><label for="exampleInputFile">Enter Date</label></td>
...
<tr>
    ...
    <td width="156" height="56"  align="right"><div class="form-group"><label for="exampleInputFile">Enter Start Time</label></td>

    <td width="250"><input type="time" class="form-control-file" name="start_time" id="exampleInputFile" aria-describedby="fileHelp" required placeholder="Enter Start Time"></td>
...
<tr>
    ...
    <td width="156" height="56"  align="right"><div class="form-group"><label for="exampleInputFile">Enter End Time</label></td>

    <td width="250"><input type="time" class="form-control-file" name="end_time" id="exampleInputFile" aria-describedby="fileHelp" required placeholder="Enter End Time"></td>
...
<tr>
    ...
    <td height="38" colspan="2" align="center"><input type="submit" class="btn btn-info" value="Upload" name="event_add" /></td>
