...
?>
<script>
alert(" The Room resevation is sucessfully");
</script>
<?php
}
?>
		...
		<!--//header-w3l-->
			<!--/banner-info-->
			   <div class="baner-info">   
			      <h3>Wel<span>Come </span>To   <span>GTO99</span> Resorts</h3>
...
<!-- //about-bottom -->
	...
	<div class="col-md-6 w3l_about_bottom_right two">
			   ...
			   <form action="reservation.php?" method="post">
					...
					<div class="col-md-6 form-date-w3-agileits second-agile">
					 ...
					 <div class="col-md-6 form-date-w3-agileits">
									...
									<input  id="datepicker" name="text1" type="text" value="mm/dd/yyyy" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
					...
					<div class="col-md-6 form-date-w3-agileits">
						        <label><i class="fa fa-calendar" aria-hidden="true"></i> Departure Date :</label>
									<input  id="datepicker1" name="text2" type="text" value="mm/dd/yyyy" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
					...
					<div class="col-md-6 form-left-agileits-w3layouts second-agile">
							...
							<select class="form-control" name="nopeople">
								<option></option>
		...
		<div class="col-md-6 w31_about_bottom_left" style="margin-top:80px">
...
<a href="#ab" class="scroll" >Book Now</a>
				...
				<div class="col-md-3 price-grid ">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							<div class="price-list">
								<img src="images/cottage.jpg" alt=" " class="img-responsive" />
									<!--<ul>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
									<li><i class="fa fa-star-o" aria-hidden="true"></i></li>
				...
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							<div class="price-list">
                            <img src="images/guesthouse.jpg" alt=" " class="img-responsive" />
								<!--<ul>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
				...
				<div class="col-md-3 price-grid wthree lost">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							<div class="price-list">
                            <img src="images/villa.jpg" alt=" " class="img-responsive" />
								<!--<ul>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
		...
		<div class="container">
         <div class="footer-info-agile">
			...
			<div class="w3agile_footer_copy">
				    <p>© 2017 Resort. All rights reserved | Design by <a target="_blank"  href=" http://duplexsofts.com"/">duplexsofts</a></p>
			</div>
